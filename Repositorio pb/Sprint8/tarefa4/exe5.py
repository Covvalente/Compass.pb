...
df_final = df_nomes_com_pais.withColumn("AnoNascimento", expr("cast(rand() * (2010 - 1945 + 1) + 1945 as int)"))

# Selecione as colunas na ordem desejada
df_final = df_final.select("Nomes", "Escolaridade", "Pais", "AnoNascimento")
